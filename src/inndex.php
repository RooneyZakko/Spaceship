...
echo "Battle result: $battleResult";
...
<script>
    ...
    var shipTypes = ["Ship 1", "Ship 2", "Ship 3", "Enemy Ship"];
var shipCounts = [
    <?php echo $myFleet->calculateTotalDamage(); ?>,
    <?php echo $myFleet->calculateTotalDamage(); ?>,
    <?php echo $myFleet->calculateTotalDamage(); ?>,
    <?php echo $enemyFleet->calculateTotalDamage(); ?>
    ];
